...
from bulletarm.envs.close_loop_envs.close_loop_block_stacking_tr2 import createCloseLoopBlockStackingTR2Env
...
CREATE_ENV_FNS = {
  ...
  'close_loop_block_stacking_tr2': createCloseLoopBlockStackingTR2Env,
}
